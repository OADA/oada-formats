    ...
    propertySchemaToProperties: function (main_schema, opts) {
      ...
      if (prop_schema.known) {
        ...
        _.each(prop_schema.known, function(key) {
          // if the original schema already defines a property for this key,
          // don't overwrite it.  i.e. it's supposed to override the default.
          if (main_schema.properties[key]) return;
